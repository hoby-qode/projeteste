...
<section class="testimonial-page-area">
    <div class="container">
        <div class="sec-title text-center">
            <h1 class="h1 title">Paiement en ligne</h1>
        </div>
	</div>
</section>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="contact-form">
                    <div class="title text-center">						
						<h3>
							Vous pouvez r&eacute;gler votre facture en ligne via ce formulaire sécurisé<br>
							Les donn&eacute;es transmises via ce formulaires sont crypt&eacute;es.
						</h3>
                    </div>
					<div class="inner-box">	
					<?php
                        ...
                        <form id="formDPE" name="formulaire" class="default-form2" action="#" method="post" enctype="multipart/form-data">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="input-box"> 
                                        <p>Votre prénom :&nbsp;&nbsp;</p>
										<input type="text" id="prenom" name="prenom" value="<?php echo stripslashes($_POST['prenom']); ?>"/>
										<div class="clearer"></div>
                                    </div>
									<div class="input-box"> 
                                        <p>Votre adresse :&nbsp;&nbsp;</p>
										<input type="text" id="adresse" name="adresse" value="<?php echo stripslashes($_POST['adresse']); ?>"/>
										<div class="clearer"></div>
                                    </div>
									<div class="input-box"> 
                                        <p>Code postal :&nbsp;&nbsp;</p>
										<input type="text" id="codepostal" name="codepostal" value="<?php echo $_POST['codepostal']; ?>"/>
										<div class="clearer"></div>
                                    </div>
									<div class="input-box"> 
                                        <p>Ville :&nbsp;&nbsp;</p>
										<input type="text" id="ville" name="ville" value="<?php echo $_POST['ville']; ?>"/>
										<div class="clearer"></div>
                                    </div>
									<div class="input-box"> 
                                        <p>Montant &agrave; payer (<strong>&euro;</strong>):&nbsp;&nbsp;</p>
										<input type="text" id="montant" name="montant" value="<?php echo $_POST['montant']; ?>" required="required"/>
										<div class="clearer"></div>
                                    </div>
									<div class="col-md-4">
