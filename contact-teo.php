            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-contact-info-box text-center">
                    ...
                    <div class="title">
                        <h3>Téléphone</h3>
                        <p>
                            <a href="tel:00000000">00 00 00 00 00 00</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="contact-form">
                    <div class="title text-center">
                        ...
                        <h3>Laissez nous vos <span>coordonnées</span> ci-dessous.</h3>
                    </div>
<?php
if(empty($info)){
?>
                    <div class="inner-box">
                        <form id="formContact" name="#" class="default-form2" action="#" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="input-box"> 
                                        <p>Votre société</p>  
