		...
		<div class="row">
			...
			<div class="col-xl-12 col-md-12">
				<div class="contact-form">
					<p><br></p>
					<form action="#" method="post" enctype="multipart/form-data" id="formLivre" class="appnitro formLivre default-form2" style="display:none">
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-6 input-box text-center">
								<input type="submit" name="envoyer" class="btn-one btnDPE" value="Envoyer votre message"  />
							</div>
						</div>
					</form>
				</div>
