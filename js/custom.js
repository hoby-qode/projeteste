...
if ($('.tem-slide').length) {
    $('.tem-slide').owlCarousel({
        ...
        navText: ['<img src="images/qualy/icon-6.png" />', '<img src="images/qualy/icon-7.png" />'],
        responsive: {
            0: {
                items: 1
            },
...
if ($('.presta-slide').length) {
    $('.presta-slide').owlCarousel({
        animateOut: 'fadeOut',
        animateIn: 'fadeIn',
        loop: true,
        margin: 20,
...
$(document).ready(function() {
    $('.men-par').click(function(e) {
        e.preventDefault();
        $('ul.navigation > li').each(function() {
            if ($(e.target).parent('li')[0] !== this) {
                if ($($(this).children('ul')).css('display') == 'block') {
                    $($(this).children('.dropdown-btn')).click();
                }
            }
        })
        $(e.target).parent('li').children('.dropdown-btn').click();
    });
})
if ($('.actu-slide').length) {
